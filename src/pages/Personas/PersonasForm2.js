...
export default class PersonasForm2 extends Component {
  constructor(props) {
    super(props);
  ...
  initial_state = {
    ...
    canEdit: this.props.match.params.id ? false : true,
  ...
  componentDidMount() {
    ...
    this.refs.personaForm.disableFields(this.state.isForCreate === false && this.state.canEdit === false);
  }
  init_validator() {
  ...
  onSubmit = async (e) => {
    e.preventDefault();
    if (
      (this.validator.allValid() && this.state.createUser === false) ||
      ...
      if (!this.state.isForCreate) {
        ...
        HTTP.create(data, "persona", "personas", "personas").then((result) => {
  ...
  getPersonUserIfExists() {
    HTTP.findById(this.state.codigo, "usuarios/all").then((result) => {
      this.setState({
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          <PersonaFormComponent ref="personaForm" /* disable={this.state.isForCreate === false && this.state.canEdit === false} forUpdate={!this.state.isForCreate} */>
          </PersonaFormComponent>
          <fieldset
            disabled={
              this.state.isForCreate === false && this.state.canEdit === false
            }
          >
            <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 form-group">
                ...
                <SimpleSelect
                  isDisabled={
                    (this.state.municipiosNacimiento == null &&
                      this.state.isForCreate) ||
                    (this.state.isForCreate === false &&
                      this.state.canEdit === false)
                  }
              ...
              <div className="col-lg-4 form-group">
                ...
                <SimpleSelect
                  isDisabled={
                    (this.state.cantonesNacimiento == null &&
                      this.state.isForCreate) ||
                    (this.state.isForCreate === false &&
                      this.state.canEdit === false)
                  }
              ...
              <div className="col-lg-4 form-group">
                ...
                <SimpleSelect
                  isDisabled={
                    (this.state.municipiosResidencia == null &&
                      this.state.isForCreate) ||
                    (this.state.isForCreate === false &&
                      this.state.canEdit === false)
                  }
              ...
              <div className="col-lg-4 form-group">
                ...
                <SimpleSelect
                  isDisabled={
                    (this.state.cantonesResidencia == null &&
                      this.state.isForCreate) ||
                    (this.state.isForCreate === false &&
                      this.state.canEdit === false)
                  }
